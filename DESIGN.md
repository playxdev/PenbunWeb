...
| บทบาท | ฟอนต์ | ใช้ที่ |
|---|---|---|
| UI / body | **Inter** + **IBM Plex Sans Thai** | ทุกอย่าง |
| ตัวเลข | Inter `tabular-nums` + `zero` slash | ทุกช่องที่เป็นจำนวนหรือเงิน |
...
- Grid 12 คอลัมน์ ระยะห่าง 16px, เนื้อหากว้างสุด 1440px
...
ตัวอักษร: Inter + IBM Plex Sans Thai, ตัวเลขทุกช่องใช้ tabular-nums,
รหัสเอกสาร/SKU ใช้ IBM Plex Mono, ขนาดฐาน 14px และ 13px ในตาราง

โครงหน้า: grid 12 คอลัมน์ ระยะ 16px กว้างสุด 1440px ระยะทุกค่าเป็นทวีคูณของ 4
